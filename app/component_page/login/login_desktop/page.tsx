  ...
  return (
    <div className="bg-[#2A2140] bg-opacity-70 w-screen ml-auto mr-auto h-screen grid place-items-center">
      ...
      >
        <form
          id="isiContent"
          className="bg-[#2A2140] rounded-[10px] w-full pt-[37px] xl:pt-8 flex items-center flex-col"
        >
          <p
            id="judul"
          ...
          <div className="flex gap-x-[10px] mb-[28px]">
            ...
            <p className={`${poppins.className} text-[6px] xl:text-[9px] font-bold`}>Sign in with</p>
            <img src="/assets/stroke.svg" alt="" className="w-[117px] xl:w-[140px]" />
          </div>
          ...
          <p className="text-[10px] font-bold mb-8">Belum memiliki akun? <a href="/register" className="text-[#01FFFF]">Sign Up</a> sekarang</p>
        </form>
      </div>
    </div>
  );
